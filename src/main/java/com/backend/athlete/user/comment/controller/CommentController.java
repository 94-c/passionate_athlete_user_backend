package com.backend.athlete.user.comment.controller;

import com.backend.athlete.user.comment.application.CommentService;
import com.backend.athlete.user.comment.dto.request.CreateCommentRequest;
import com.backend.athlete.user.comment.dto.request.UpdateCommentRequest;
import com.backend.athlete.user.comment.dto.response.CreateCommentResponse;
import com.backend.athlete.user.comment.dto.response.GetCommentResponse;
import com.backend.athlete.user.comment.dto.response.UpdateCommentResponse;
