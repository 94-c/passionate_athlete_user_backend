package com.backend.athlete.user.physical.controller;

import com.backend.athlete.user.physical.application.PhysicalService;
import com.backend.athlete.user.physical.dto.request.CreatePhysicalRequest;
import com.backend.athlete.user.physical.dto.request.UpdatePhysicalRequest;
import com.backend.athlete.user.physical.dto.response.*;
